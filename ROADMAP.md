...
[![Current Version](https://img.shields.io/badge/Current-v0.4.0-22c55e?style=flat-square)](#v040--always-on-orb--installer-current-release)
...
| **v0.4.0** | ✅ **Current** | Always-on orb overlay, typed input, Ollama auto-start, installer |
...
## v0.4.0 — Always-on orb + installer *(current release)*
