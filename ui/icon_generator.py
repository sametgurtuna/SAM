...
# Generates system tray icon at runtime using QPainter
# when an external .ico file is not found.
...
def create_tray_icon() -> QIcon:
    """
    Generate fallback system tray icon for SAM.
    Renders cyan 'S' on dark rounded square.
    """
    SIZE = 64
